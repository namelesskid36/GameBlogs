...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/home-svg.css">
    <link rel="stylesheet" href="../assets/css/ct-style.css">
...
<div class="bg">
    ...
    <body>
            ...
            <div class="right-links">
                ...
                <style>
                    .Btn {
                        ...
                        background-color: rgb(120, 24, 145);
                    }
        ...
        <main class="main">
                ...
                <div class="top">
                    <div class="box">
                        <h2 style="color: white;" text-align: right;>Hello <b>
                                <?php echo $res_Uname ?>, Welcome</h2>
                        <p>We're thrilled to have you here. Explore, share, and connect with fellow gamers in our
                            vibrant
                            community!</p>
                    </div>
                </div>
            ...
            <br>
            <button><a href="blog-create.php">Create</a></button> &ensp;
            <button><a href="blog-view.php">Read</a></button> <br>
...
<div>
    <?php include("tranding-index.php");
    ?>
</div>
<section class="heroa" style="background-color: white;" id="about-us">
    <div class="diva">
        <h1 class="h1a" style="color: Black;">About US</h1>
        <p class="pa" style="color: Black;">Welcome to Game Hub! We are a passionate team of gamers dedicated to
            providing you with the best gaming content and experiences. Our mission is to create a vibrant community
            where gamers of all levels can come together to share their love for gaming. Whether you're a seasoned
            player or just starting out, we've got something for everyone. From game reviews and tutorials to gaming
            news and discussions, we strive to bring you valuable and engaging content. Join us on this exciting journey
            as we explore the world of gaming and unleash the power of play!</p>

        <button class="btna" onclick="window.location.href='team5.php'">
            <span> Contact Team
            </span>
        </button>
    </div>
    <img class="imga" src="https://icon-library.com/images/group-icon-png/group-icon-png-7.jpg" alt="">
</section>
...
<footer>
    <div class="footer-container">
        ...
        <div class="sec quicklinks">
            ...
            <ul>
                <li><a href="#">Home</a></li>
                <li><a href="#" onclick="scrollToSection('about-us')">About</a></li>
