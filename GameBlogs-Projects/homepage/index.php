...
<body>
    ...
    <section class="about container" id="about">
        ...
        <div class="imgBx">
            <img src="images/white.png" alt="" class="fitBg">
        </div>
    </section>
    ...
    <div class="post container">
        ...
        <div class="post-box openworld">
            <img src="images/gtav.png" alt="" class="post-img">
        ...
        <div class="post-box racing">
            <img src="images/forza.png" alt="" class="post-img">
        ...
        <!-- Post 3 -->
        <div class="post-box racing">
            <img src="images/nfsheat.png" alt="" class="post-img">
            <h2 class="category">Racing</h2>
        ...
        <div class="post-box battleroyal">
            <img src="images/apex.png" alt="" class="post-img">
        ...
        <!-- Post 5 -->
        <div class="post-box openworld">
            <img src="images/minecraft.png" alt="" class="post-img">
            <h2 class="category">Open World</h2>
        ...
        <!-- Post 6 -->
        <div class="post-box battleroyal">
            <img src="images/fortnite.png" alt="" class="post-img">
            <h2 class="category">Battle Royal</h2>
        ...
        <!-- Post 7 -->
        <div class="post-box openworld">
            <img src="images/rdm2.png" alt="" class="post-img">
            <h2 class="category">Open World</h2>
        ...
        <!-- Post 1 -->
        <div class="post-box battleroyal">
            <img src="images/pubg.png" alt="" class="post-img">
            <h2 class="category">Battle Royal</h2>
        ...
        <!-- Post 9 -->
        <div class="post-box racing">
            <img src="images/dirt5.png" alt="" class="post-img">
            <h2 class="category">Racing</h2>
        ...
        <div class="footer-container">
            ...
            <div class="sec quicklinks">
                ...
                <ul>
                    ...
                    <li><a href="../team5/index.php">Contact team</a></li>
